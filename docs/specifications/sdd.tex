...
\diagram[large-wide]{05a-full-domain-classes}{Full system class diagram}{Every persisted
class across Identity, Academic, Finance and HR with attributes, in-service associations
and cross-boundary logical references consolidated into one object model.}
