...
Then:
    ...
    docker compose exec academic python -m scripts.cleanup_test_data --keep <uuid>

    # actually delete:
    docker compose exec academic python -m scripts.cleanup_test_data --keep <uuid> --apply
